...
//        }
    ...
    private PreviewCallback previewCallback = new PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            if (totalTimeInSecs >= 13) { //when 30 seconds of measuring passes do the following " we chose 30 seconds to take half sample since 60 seconds is normally a full sample of the heart beat
                ...
                double R = (varr/meanr)/((varb+0.01)/meanb);
                //double R2 = meanb/meanr;
                ...
                if (( o2 < 80 || o2 > 101) || (bpm < 45 || bpm > 200)) {
                    ...
                    ProgP=inc;
                    ProgO2.setProgress(ProgP);
                    mainToast = Toast.makeText(getApplicationContext(), "Measurement Failed"+String.valueOf(R),Toast.LENGTH_SHORT);
                    mainToast.show();
                    startTime = System.currentTimeMillis();
                    counter=0;
                    processing.set(false);
...
//        super.onBackPressed();
//        Intent i = new Intent(O2Process.this, HealthFunctions.class);
//        //i.putExtra("Usr", user);
//        startActivity(i);
//        finish();
//    }
