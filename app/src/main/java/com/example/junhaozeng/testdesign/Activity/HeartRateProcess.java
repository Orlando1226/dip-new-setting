...
//        }
    ...
    private PreviewCallback previewCallback = new PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            if (totalTimeInSecs >= 20) { //when 30 seconds of measuring passes do the following " we chose 30 seconds to take half sample since 60 seconds is normally a full sample of the heart beat
                ...
                Log.d(TAG, String.valueOf(Beats));
            }
    ...
    private void initChart(){
        chart = (LineChart) findViewById(R.id.hr_lc);
    ...
    private void addEntry(int x,int y){
        ...
        chart.moveViewToX(lineData.getEntryCount() - 40);//change number later
    }
...
//        super.onBackPressed();
//        Intent i = new Intent(HeartRateProcess.this, HealthFunctions.class);
//        startActivity(i);
//        finish();
//    }
}